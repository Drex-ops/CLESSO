##############################################################################
##
## plot_combined_timeseries_eastern_states_sans_HYM_VAS.R
##
...
##
## Usage:
##   Rscript plot_combined_timeseries_eastern_states_sans_HYM_VAS.R
##
##############################################################################
...
# ---------------------------------------------------------------------------
groups <- c("AMP", "MAM", "REP", "VAS")
prefix <- "eastern_states_sans_HYM_VAS"
